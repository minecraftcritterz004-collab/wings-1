  ...
  return (
    <>
      <div className="fixed inset-0 pointer-events-none overflow-hidden opacity-20">
        <Heart className="absolute top-20 left-10 w-12 h-12 text-red-500 animate-rotate-slow" />
        ...
        <Gift className="absolute bottom-40 left-16 w-10 h-10 text-red-500 animate-rotate-reverse" />
        <Star className="absolute bottom-60 right-20 w-12 h-12 text-accent animate-float-gentle" />
        <Heart className="absolute top-1/2 left-8 w-8 h-8 text-red-500 animate-rotate-slow" />
